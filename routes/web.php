...
Route::middleware('auth')->get('/pesan', function () {
    return view('pesan');
});
Route::middleware('auth')->post('/product/store/user', [App\Http\Controllers\Backend\ProductController::class, 'storeuser'])->name('product.store.user');
Route::middleware('auth')->get('/product/store/user', [App\Http\Controllers\Backend\ProductController::class, 'viewqr'])->name('product.store.view');
Route::middleware('auth')->get('/users', [App\Http\Controllers\Backend\UserController::class, 'index'])->name('user.index');